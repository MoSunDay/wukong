...
* 支持中文分词（使用[sego分词包](https://github.com/MoSunDay/sego)并发分词，速度27MB/秒）
...
```
go get -u -v github.com/MoSunDay/wukong
```
...
func main() {
	...
	searcher.Init(types.EngineInitOptions{
		SegmenterDictionaries: "github.com/MoSunDay/wukong/data/dictionary.txt"})
